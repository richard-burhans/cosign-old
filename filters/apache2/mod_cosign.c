...
#ifdef HAVE_APACHE_USERAGENT_IP
#define COSIGN_REMOTE_IP useragent_ip
#else /* !HAVE_APACHE_USERAGENT_IP */
#define COSIGN_REMOTE_IP connection->remote_ip
#endif /* HAVE_APACHE_USERAGENT_IP */
